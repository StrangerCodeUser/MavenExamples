...
-- Volcando datos para la tabla bd_arlet.apprentice: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `apprentice` DISABLE KEYS */;
INSERT INTO `apprentice` (`document`, `full_name`, `id_course`) VALUES
	(111600200, 'Homero J. Simpson', 2305023),
	(1116000100, 'Ned Flanders', 2395066);
...
-- Volcando datos para la tabla bd_arlet.course: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='tabla llegadas tarde';

-- Volcando datos para la tabla bd_arlet.late_arrival: ~0 rows (aproximadamente)
